...
MASTODON_BASE_URL = ENV['MASTODON_BASE_URL'] || ENV['MASTODON_DOMAIN']
MASTODON_TOKEN = ENV['MASTODON_TOKEN'] || ENV['ACCESS_TOKEN']

unless MASTODON_TOKEN
...
5.times do  # 최대 5번 반복 (200개씩 = 최대 1000개)
  options = { limit: 200 }
